...
object ConnHelper extends Serializable{
  lazy val jedis = new Jedis("192.168.10.107")
  lazy val mongoClient = MongoClient( MongoClientURI("mongodb://192.168.10.107:27017/recommender") )
}
...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://192.168.10.107:27017/recommender",
